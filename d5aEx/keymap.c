...
#define KC_A MT(MOD_LGUI, KC_A)
#define KC_S MT(MOD_LSFT, KC_S)
#define KC_D MT(MOD_LCTL, KC_D)
#define KC_F MT(MOD_LSFT, KC_F)
#define KC_G MT(MOD_LALT, KC_G)
#define KC_H MT(MOD_LALT, KC_H)
#define KC_J MT(MOD_RSFT, KC_J)
#define KC_K MT(MOD_LCTL, KC_K)
#define KC_L MT(MOD_RSFT, KC_L)
#define KC_SCLN MT(MOD_LGUI, KC_SCLN)
...
const uint16_t PROGMEM combo4[] = { KC_S, KC_D,     COMBO_END}; // {
